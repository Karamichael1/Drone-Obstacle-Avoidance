...
ax1.plot(dynamic_df['Difficulty'], dynamic_df['Avg Path Length'], marker='s', label='Dynamic Window(local)')
...
ax2.plot(dynamic_df['Difficulty'], dynamic_df['Avg Time'], marker='s', label='Dynamic Window(local)')
